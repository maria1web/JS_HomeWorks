class Settings {
    ...
    init(params) {
        ...
        // {rowsCount: 21, colsCount: 21, speed: 2, winLength: 50}
        // { speed: 5, winLength: 5 }
        // метод assign заменяет дефолтные параметры на те,
        // что переданы при ините в файле main.
        // копирование с заменой происходит справа налево
        // получим: defaultParams = {rowsCount: 21, colsCount: 21, speed: 5, winLength: 5}
